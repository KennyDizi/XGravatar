...
namespace XGravatar.SourceCode.Utilities.Gravatar
{
    ...
    public static class Md5Core
    {
        ...
        private static IEnumerable<byte> GetHash(string input, Encoding encoding)
        {
            if (null == input)
        ...
        public static IEnumerable<byte> GetHash(string input)
        {
        ...
        */
        ...
        private static uint[] Converter(IReadOnlyList<byte> input, int ibStart)
        {
            if (null == input)
